# Generated by Django 2.2.2 on 2019-06-17 20:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decidedBy', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='decidedBy', to='web.Person')),
                ('requester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requester', to='web.Person')),
            ],
        ),
    ]
