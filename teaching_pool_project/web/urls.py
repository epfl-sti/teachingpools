...
urlpatterns = [
    ...
    re_path('requests/TAs/reports/courses_without_requests/(?P<year>\d{4}-\d{4})/(?P<term>.*)', views.get_courses_without_numberOfTARequests, name="get_courses_without_numberOfTARequests"),
    ...
    re_path('reports/applications/(?P<year>\d{4}-\d{4})/(?P<term>.*)$', views.applications_list, name="applications_list"),
